...
from pool_share_scanner.constants import AURA_SUBGRAPH_MAINNET
...
def main():
    ...
    pool_gauge_pairs_mainnet = {
        "191": "0xc859bf9d7b8c557bbd229565124c2c09269f3aef",  # rsETH-ETHx
        "182": "-",  # rETH-weETH
    }
    ...
    for pool_id, gauge_id in pool_gauge_pairs_mainnet.items():
        pool_results = fetch_aura_pool_shares(pool_id, block, AURA_SUBGRAPH_MAINNET)
