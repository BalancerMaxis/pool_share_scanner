...
def main():
    ...
    merged_data = process_balancer_pool_user_bpts(pool_gauge_pairs_mainnet, block, BALANCER_SUBGRAPH_BY_CHAIN['mainnet'],
    ...
    merged_data_zkevm = process_balancer_pool_user_bpts(pool_gauge_pairs_zkevm, block_zkevm,
                                                        BALANCER_SUBGRAPH_BY_CHAIN['zkevm'], BALANCER_GAUGE_SUBGRAPH_BY_CHAIN['zkevm'])
